...
from thermal_bootstrap_header_file import run_sdp
...
for L in [10]:
    for m in [3]:
        ...
        input_file = f"/home/pripoll/Documents/Uni_Classes/Masters_thesis/anharmonic_thermal/thermal_anharmonic/wolfram_output/anharmonic_output_for_l={L}_m={m}_k={m}.json"

        scs_parameters = {"max_iters":30000,"eps":1e-5,"eps_abs":1e-5,"eps_rel":1e-5,"acceleration_lookback":10,"normalize":True,"scale":1.0}
        sdpa_parameters = {"maxIterations":1000,"print":"display"}
        # I ran the lower bound yesterday.
